...
class XGTransitionAnimation: NSObject,UIViewControllerTransitioningDelegate
{
    /// 是否是presented
...
extension XGTransitionAnimation:UIViewControllerAnimatedTransitioning
{
    // 动画时长
